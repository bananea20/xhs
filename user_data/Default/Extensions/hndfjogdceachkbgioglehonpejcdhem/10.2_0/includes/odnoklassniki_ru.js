!function(e) {
    ...
    92: function(e, t, o) {
        "use strict";
        o.r(t);
        var n = o(0), a = o(10), r = o(15), i = o(29), s = o(25), d = o(23), l = o(37), c = o(12), u = o(22), p = o(16), f = o(32), h = o(3), m = o(1), v = o(14), g = o(6), k = o(7), y = o(55), b = o(18), w = o(11), x = o(38), M = o(13), O = o(61), _ = o(8), S = o(17), L = o(9);
        const C = o(36), P = Object(k.a)("odnoklassniki_ru"), I = navigator.userAgent.includes("Safari") && !navigator.userAgent.includes("Chrome");
        b.a.isSingle() && Object(r.b)("odnoklassniki", (function(e, t) {
            const r = Object(a.a)(t);
            var k = t.preferences, b = k.moduleOdnoklassniki ? 1 : 0, N = n.a.isChrome || n.a.isFirefox || n.a.isGM && n.a.isTM;
            n.a.onMessage.addListener((function(t, o, n) {
                ...
                "updatePreferences" !== t.action ? b && ("updateLinks" === t.action && j(), "downloadMP3Files" === t.action && (N ? E.downloadMP3Files() : E.showListOfAudioFiles(!1)), 
                "downloadPlaylist" === t.action && E.showListOfAudioFiles(!0)) : Object.assign(k, t.preferences);
            ...
            var q = {
                ...
                videoToken: null,
                run: function() {
                    if (b = 1, E.getJsSessionId(), T.injectStyle(), D.injectStyle(), w.a.isAvailable()) return q.mutationMode.enable();
                },
                changeState: function(e) {
                    b = e, R.rmBtn(), E.disable(), D.rmCurrentPhotoBtn(), T.disable(), T.rmBtn(), q.hideMenu(), 
                ...
                mutationMode: {
                    ...
                    wrapVideoFeedOnImgOver: function() {
                        b && T.onImgOver.call(this);
                    },
                    wrapAudioOnMouseOver: function() {
                        b && E.onMouseOver.apply(this, arguments);
                    },
                    wrapAudioOnMouseOut: function() {
                        b && E.onMouseOut.apply(this, arguments);
                    },
                    wrapNewAudioOnMouseEnter: function() {
                        if (b) try {
                            E.onNewMouseEnter.apply(this, arguments);
                        } catch (e) {
                            P.error("wrapNewAudioOnMouseEnter error", e);
                        }
                    },
                    enable: function() {
                        ...
                        const t = t => {
                            ...
                            let {added: t} = e;
                            t.forEach(e => {
                                e.sfSkip || (e.sfSkip = "1", E.appendDownloadMobileMusic(e));
                            });
                        }, a = t => {
                            ...
                            t.forEach(e => {
                                ...
                                t && R.appendDownloadMobileVideo(t);
                            });
                        }, d = [];
                            ...
                            queries: [ ...d, {
                                ...
                                callback: async e => {
                                    ...
                                    t.filter(e => !e.dataset.sfReady).map(e => (e.dataset.sfReady = 1, e)).map(e => {
                                        ...
                                        e.addEventListener("mouseenter", () => {
                                            ...
                                            const o = e.closest(".track-with-cover"), a = o.querySelector('[data-l="t,artist"]').textContent, r = o.querySelector('[data-l="t,title"]').textContent, i = g.a.modify(`${a} - ${r}`);
                                            n.a.sendMessage({
                                                action: "downloadFile",
                                                options: {
                                                    filename: i + ".mp3",
                                ...
                                callback: e => {
                                    for (let t, o = 0; t = e.added[o]; o++) {
                                        ...
                                        if (!e) return;
                                        const o = R.getPlayerOptions(t);
                                        o && R.appendLinkUnderVideo(e.parentNode, o, t);
                                    }
                                }
                            }, {
                ...
                q.clearCache(), A(), E.getJsSessionId(), R.catchPopup();
            }, A = function() {
                    ...
                    const t = m.a.create("a", {
                        ...
                        on: [ "click", async function(t) {
                            t.preventDefault(), t.stopPropagation(), L.a.createLinkExtractor("ok-music").extractLinks({
                                ...
                                P.error("appendDownloadMobileMusic. click download error", e), this.style.opacity = .3;
                            });
                        } ]
                ...
                showRowLinks: function(e) {
                    var t = E.getTrackId(e);
                    for (var o in t) if (E.handleRow(o, t[o])) return !0;
                    return !1;
                },
                disable: function() {
                    E.lastRowCandidate = null, E.lastRow = null;
                ...
                getJsSessionId: function() {
                    return ("m.ok.ru" === location.host ? () => {
                        ...
                        P.debug("getJsSessionId error", e);
                    }));
                },
                getLink: function(e) {
                    e && E.jsessionId && (E.ajaxTimer[e] = window.setTimeout((function() {
                        delete E.ajaxTimer[e], E.deleteLink(e);
                    }), 3e4), n.a.sendMessage({
                        ...
                        E.setLink(e.trackId, e.data);
                    })));
                },
                onMouseOver: function() {
                    if (E.jsessionId) {
                        var e = this;
                        e && (E.lastRowCandidate = e, clearTimeout(E.timer), E.lastRow !== e && (E.timer = window.setTimeout((function() {
                            E.showRowElements(E.lastRow, !1), E.lastRow = e, E.lastRowCandidate = null, E.showRowElements(E.lastRow, !0);
                        }), 250)));
                    }
                },
                onMouseOut: function() {
                    var e = this;
                    (E.lastRow && E.lastRow.contains(e) || E.lastRowCandidate && E.lastRowCandidate.contains(e)) && (clearTimeout(E.timer), 
                    E.timer = window.setTimeout((function() {
                        E.showRowElements(E.lastRow, !1), E.lastRow = null, E.lastRowCandidate = null;
                    }), 1e3)), e = null;
                },
                onNewMouseEnter(e) {
                    if (!this.querySelector(".savefrom_ok_download")) {
                        ...
                        return E.getNodeTrack(e).then(e => {
                            "WM-TRACK2" === this.tagName ? E.insertButtonOnOver(this, e) : E.insertButton(this, e);
                        });
                    }
                },
                ...
                insertButton(e, t) {
                    ...
                    const a = m.a.create("a", {
                        ...
                        on: [ [ "mouseenter", E.handlePreload ], [ "click", E.handleClickNewButton ], [ "mouseenter", function() {
                            F.tooltip.textContent = E.getNewButtonTooltipLabel(this), F.show(this);
                        } ], [ "mouseleave", function() {
                            F.hide();
                        } ], [ "sf-state-change", function() {
                            F.tooltip.textContent = E.getNewButtonTooltipLabel(this), F.updatePos(this);
                        } ], [ "mouseover", e => {
                            if (I) {
                ...
                handlePreload(e) {
                    ...
                    return L.a.createLinkExtractor("ok-music").extractLinks({
                        ...
                        this.dataset.downloadOnReady > 0 && E.handleClickNewButton.call(this, e);
                    }).catch(e => {
                        P.error("LinkExtractor error", e), this.dataset.state = "error", this.dispatchEvent(new CustomEvent("sf-state-change"));
                    });
                },
                ...
                handleRow: function(e, t) {
                    ...
                    d && d.contains(t) && (s = 65), r.setStyle(i, {
                        ...
                        zIndex: 9999,
                        cursor: "pointer"
                    }), i.addEventListener("click", E.onBoxClick, !1), i.addEventListener("mousedown", (function(e) {
                        e.stopPropagation();
                    }), !1);
                    var l = E.getTitle(e, t), c = function(e, t, o) {
                        null == o && (o = !0);
                        var n = document.createElement("a");
                        return n.href = e, n.className = "savefrom_ok_download", n.textContent = t, o && n.setAttribute("target", "_blank"), 
                        n;
                    }("#", "...");
                    c.id = E.downloadIdPrefix + e, c.title = n.a.i18n.getMessage("downloadTitle"), a && c.setAttribute("data-savefrom-helper-duration", E.secondsFromDurationNode(a)), 
                    l && (l += ".mp3", c.setAttribute("download", g.a.modify(l))), r.setStyle(c, {
                        color: "#fff",
                        fontWeight: "normal"
                    }), c.addEventListener("click", E.onDownloadLinkClick, !1), i.appendChild(c), o.appendChild(i), 
                    E.cache[e] ? E.setLinkFromCache(e, c) : E.getLink(e), i.style.marginTop = "-" + i.offsetHeight / 2 + "px", 
                    i.style.opacity = "1";
                    ...
                    r.setStyle(u, {
                        ...
                        opacity: ".7",
                        cursor: "pointer"
                    }), u.addEventListener("click", E.onCloseBtnClick, !1), i.appendChild(u), !0;
                },
                ...
                deleteLink: function(e, t) {
                    if (!t && e && (t = document.getElementById(E.downloadIdPrefix + e)), t) {
                        var o = t.parentNode;
                ...
                setLinkFromCache: function(e, t) {
                    if (!E.cache[e]) return !1;
                    if (t || (t = document.getElementById(E.downloadIdPrefix + e)), t) {
                        t.href = E.cache[e].url, t.textContent = "", E.cache[e].downloadAttr && t.setAttribute("download", E.cache[e].downloadAttr);
                        ...
                        t.appendChild(o);
                        var n = document.createTextNode(E.cache[e].info);
                ...
                setLink: function(e, t, o) {
                    if (e) {
                        clearTimeout(E.ajaxTimer[e]);
                        var a = document.getElementById(E.downloadIdPrefix + e);
                        if (a && !E.setLinkFromCache(e, a)) {
                            if (!t || !t.play) return E.deleteLink(e, a), void (a.textContent = "?");
                            ...
                            E.cache[e] = {}, E.cache[e].url = t.play + (o ? "&clientHash=" + o : "");
                            ...
                            if (t.track && (t.track.duration && (d = t.track.duration), t.track.ensemble && t.track.name)) {
                                ...
                                E.cache[e].title = l, E.cache[e].downloadAttr = g.a.modify(l + ".mp3");
                            }
                            if (i && i > 0 && d) {
                                if (d = parseInt(d), isNaN(d)) return void delete E.cache[e];
                                s += " ~ " + (Math.floor(i / d / 125) + " " + n.a.i18n.getMessage("kbps"));
                            }
                            s += ")", E.cache[e].info = s, E.setLinkFromCache(e, a);
                        }
                    }
                },
                ...
                getLayer: function() {
                    ...
                    e && !E.elIsHidden(e))) return e;
                },
                getNewLayer: function() {
                    let e = document.querySelector("#music_layer wm-collection-section");
                    if (e || (e = document.querySelector("#music_layer")), !e || !E.elIsHidden(e)) return e;
                },
                                ...
                                Array.isArray(o) && o.forEach((function(e) {
                                    n = n.then((function() {
                                        if ("string" == typeof e.play && "object" == typeof e.track) {
                                            ...
                                            t || (t = "noname"), E.getClientHash(o).then((function(n) {
                                        ...
                                        P.debug("process item error", e, t);
                                    }));
                                })), n.then((function() {
                                    t(i - e.length, i), s();
                                }));
                ...
                downloadMP3Files: function() {
                    const e = E.getLayer() || E.getNewLayer() || document, t = E.getPlaylistName(e) || E.getNewPlaylistName(e);
                    E.getAudioLinks(e, t, (function(e) {
                ...
                showListOfAudioFiles: function(e) {
                    const t = E.getLayer() || E.getNewLayer() || document, o = E.getPlaylistName(t) || E.getNewPlaylistName(t);
                    E.getAudioLinks(t, o, (function(t) {
                ...
                requestMobileToken: function(e, t) {
                    ...
                    Object(v.a)(() => {
                        ...
                        n.a.isChrome || n.a.isFirefox ? Object(v.a)([ o ], a).then(i) : a(o).then(i);
                    });
                },
                getMobileToken: function(e, t) {
                    if (e.vtkn) return t(e);
                    var o = q.videoToken;
                    return o && o.expire > Date.now() ? (e.vtkn = o.vtkn, t(e)) : R.requestMobileToken(e, t);
                },
                wrapMobileLinks: function(e, t) {
                    R.getMobileToken(e, (function(e) {
                ...
                prepareResponse: function(e, t) {
                    ...
                    if ("getOkViaMobile" === e.action) return R.wrapMobileLinks(e, (function(e) {
                        if (!e) return o();
                        R.prepareResponse(e, t);
                    }));
                    var a = null;
                    ...
                    var i = null;
                    return i = a ? r.popupMenu.prepareLinks[a](e.links, e.title) : T.prepareLinks(e.links, e.title), 
                    t(i);
                },
                ...
                getPlayerMetadata: function(e, t, o, n) {
                    ...
                    n && (a.mtId = t), Object(f.a)({
                        method: "POST",
                        url: location.protocol + "//" + location.host + "/dk?" + C.stringify(a),
                        json: !0,
                        localXHR: !0
                    }, (function(a, r, i) {
                        return a ? !n && t ? void R.getPlayerMetadata(e, t, o, 1) : o() : o(i);
                    }));
                },
                getEmbed: function(e, t) {
                    var o = Object(s.a)(e);
                    if (!o.id || !o.sig) return t();
                    var a = "http://cdn-ok.com/video/get/?" + C.stringify({
                        id: o.id,
                        format: 1,
                        sig: o.sig,
                        sig2: "oldRotator"
                ...
                readMetadata: function(e, t, o) {
                    ...
                    if (!o && e.movie && e.movie.movieId) {
                        ...
                        return this.getPlayerMetadata(e.movie.movieId, a, (function(o) {
                            R.readMetadata(o || e, t, 1);
                        }));
                    }
                    var r = this.switchMetadataProvider(e);
                    return r ? r.links ? t(r.links) : void (r.request ? "getRutubeLinks" === r.request.action ? R.prepareResponse(r.request, t) : "wrapMobileLinks" === r.request.action ? R.wrapMobileLinks(r.request, (function(e) {
                        R.prepareResponse(e, (function(e) {
                            t(e, 1);
                        }));
                ...
                loadLinks: function(e, o, a) {
                    ...
                    var d = function(e, s) {
                        ...
                        return e ? e.hlsManifestUrl ? L.a.createLinkExtractor("ok-video").extractLinks({
                            ...
                            d(), P.error("hls error", e);
                        }) : void R.readMetadata(e, (e, t) => {
                            if (!e) return d();
                    ...
                    e.metadata ? d(e.metadata) : e.request ? "getOkMetadata" === e.request.action ? n.a.sendMessage(e.request, d) : "getPlayerMetadata" === e.request.action ? this.getPlayerMetadata(e.request.extVideoId, e.request.sid, (function(e) {
                        d(e, 1);
                    })) : "getRutubeLinks" === e.request.action ? R.prepareResponse(e.request, (function(e) {
                        o.update(e);
                    })) : n.a.sendMessage(e.request, (function(e) {
                        R.prepareResponse(e, (function(e) {
                            o.update(e);
                ...
                appendDownloadMobileVideo(e) {
                    ...
                    t.right = "0");
                    const a = R.createMobileDownloadContainer(n, {
                        containerStyle: t,
                ...
                async getMobilePlayerOptions(e) {
                    ...
                    if (!o) return void P.error("getMobilePlayerOptions. video id not found");
                    const n = await Object(M.a)({
                        action: "okRequestVideoPage",
                        videoId: o
                    });
                    if (!n) return void P.error("getMobilePlayerOptions. videoPage fetch failed");
                    const a = Object(O.a)(n, "").querySelector(".vp_video .vid-card_cnt");
                    if (!a) return void P.error("getMobilePlayerOptions. Video dataset not found");
                    const r = R.getPlayerOptions(a);
                ...
                catchPopup: function() {
                    ...
                    this.lastWaitEl && this.lastWaitEl.abort(), this.lastWaitEl = this.waitEl((function() {
                        ...
                        if (t) {
                            var o = R.getPlayerOptions(e);
                            o && R.appendLinkUnderVideo(t.parentNode, o, e);
                        }
                    }));
                },
                rmBtn: function() {
                ...
                onImgOver: function(e) {
                    ...
                    o) && (!o.getElementsByClassName(T.btnClassName).length && !!!o.querySelector(".vid-card_live.__active"))) {
                        var a = Object(u.a)(this, ".vid-card_img__link " + this.tagName), s = R.getPlayerOptions(this);
                        if (s || (s = T.getPosterData(this)), s) {
                            s.isChat = t;
                            var d = {};
                            t && Object.assign(d, {
                                left: "15px",
                            ...
                            var l = m.a.create("i", {
                                class: [ T.btnClassName, "sf-video-feed-bind-on-insert" ],
                                style: d,
                                data: {
