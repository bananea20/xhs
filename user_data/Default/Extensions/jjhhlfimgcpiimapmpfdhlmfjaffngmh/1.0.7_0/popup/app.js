...
define(33, function (require, exports, module) {
exports.store = {
  scripts: [],
  commands: [],
  domains: [],
...
define(34, function (require, exports, module) {
var app = require(32);
var MixIn = require(37);
var _ = require(13);
...
define(35, function (require, exports, module) {
...
define(36, function (require, exports, module) {
var app = require(32);
var MixIn = require(37);
var _ = require(13);
    ...
    return {
      top: [{
        ...
        onClick: function () {
          ...
          name: _.i18n('menuLibraryScripts'),
          symbol: 'book',
          onClick: function () {
            var url = chrome.extension.getURL(chrome.runtime.getManifest().options_page);
            chrome.tabs.query({
              ...
              if (tab) chrome.tabs.update(tab.id, {active: true});
              else chrome.tabs.create({url: url  + '#main/Library'});
            });
          }
        }, {
        name: null,
...
define(37, function (require, exports, module) {
var MenuItem = require(35);
var cache = require(12);
var utils = require(33);

module.exports = {
  template: cache.get(13),
  data: function () {
    return {
      store: utils.store,
    };
